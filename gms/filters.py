...
class GMSHHARotationFilter(django_filters.FilterSet):
    class Meta:
        model = HHARotation
...
class GMSHHAStudentFilter(django_filters.FilterSet):
    class Meta:
        model = HHAStudent
...
class GMSHHATheoryRecordFilter(django_filters.FilterSet):
    class Meta:
...
class GMSHHAClinicalRecordFilter(django_filters.FilterSet):
    class Meta:
